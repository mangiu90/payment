        ...
        <div class="col-span-7">
            <article class="card">
                <div class="card-body">
                    ...
                    <p class="text-sm text-gray-500">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus laudantium nesciunt assumenda, odit ratione quam libero. Dolores voluptates, quasi aperiam quos maxime voluptatibus ab magni, corrupti unde hic a <a class="text-blue-500 font-bold" href="#">Términos y condiciones</a>.</p>
                </div>
            </article>
        </div>
